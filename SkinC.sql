...
CREATE TABLE `prescriptions_table` (
  ...
  `time_of_examination` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  CONSTRAINT `prescriptions_table_ibfk_3` FOREIGN KEY (`type`) REFERENCES `cancer_types` (`id`)
...
INSERT INTO `prescriptions_table` VALUES (1,168,NULL,'ae8b819e-00a3-437d-a0e2-02e8095275f6.jpg',0.993379,NULL,NULL,'0000-00-00 00:00:00','POSITIVE','NF'),(2,168,NULL,'120f607c-3cf7-481d-b676-929e79a6d79f.jpg',0.993379,NULL,NULL,'0000-00-00 00:00:00','POSITIVE','NF'),(3,168,NULL,'1783cacf-7ab5-4aeb-8808-5c422dc5bc9a.jpg',0.993379,NULL,NULL,'2020-09-15 17:15:23','POSITIVE','NF'),(4,168,NULL,'a5f4ff98-63b1-413f-8390-8162d7629c2d.jpg',0.993379,NULL,NULL,'2020-09-15 17:34:06','POSITIVE','NF'),(5,168,NULL,'a9df7a45-b0ef-4202-b7e7-61a3264d4c47.jpg',0.993379,0.0808208,7,'2020-09-15 23:05:54','POSITIVE','NF');
...
-- Dump completed on 2020-09-21 17:28:31
